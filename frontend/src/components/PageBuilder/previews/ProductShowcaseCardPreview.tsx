                    ...
                    <div className={`flex flex-wrap gap-3 ${buttonJustifyClass}`}>
                      {card.primaryButtonText && (
                        <motion.a
                          ...
                          className="inline-flex items-center justify-center px-6 py-3 rounded-full font-semibold shadow-md hover:shadow-primary/25 transition-[background-color,color,box-shadow] duration-200 bg-[var(--color-text-primary)] text-[var(--color-background)] hover:bg-[var(--color-background)] hover:text-[var(--color-text-primary)]"
                      ...
                      {card.secondaryButtonText && (
                        <motion.a
                          ...
                          className="inline-flex items-center justify-center px-6 py-3 rounded-full font-semibold border border-theme-divider hover:border-primary/80 transition-[background-color,color,border-color] duration-200 bg-[var(--color-surface-alt)] text-[var(--color-text-primary)] hover:bg-[var(--color-text-primary)] hover:text-[var(--color-surface-alt)]"
                          whileHover={{ y: -2, scale: 1.02 }}
