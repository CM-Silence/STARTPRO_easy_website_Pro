      ...
      <div className={`feature-grid-container grid grid-cols-1 md:grid-cols-2 gap-8 ${
        ...
        {features.map((feature: any, index: number) => (
          <HoverFX
            ...
            className="feature-card group relative bg-color-surface p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-200 border border-color-border hover:border-primary overflow-hidden"
          >
            {/* 背景装饰 */}
            <div className="feature-card-decoration absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-full -mr-10 -mt-10 group-hover:scale-150 transition-transform duration-200"></div>

            {/* 图标 */}
            <div className="feature-icon-container relative mb-6">
              <div className="feature-icon w-16 h-16 mx-auto bg-gradient-to-br from-primary to-secondary rounded-2xl flex items-center justify-center text-2xl text-text-primary shadow-lg group-hover:scale-110 transition-transform duration-200">
