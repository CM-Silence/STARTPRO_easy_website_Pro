        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h1 className="text-xl font-bold text-theme-textPrimary">可视化页面编辑器</h1>
                    ...
                    <div
                      className={`flex items-center space-x-2 px-3 py-2 rounded-lg ${
                        isActive
                          ...
                          : isCompleted
                          ? 'bg-theme-surface text-tech-accent border border-tech-accent/50'
                          : 'bg-theme-surface text-theme-textSecondary border border-theme-divider'
                      }`}
                    >
                      <Icon className="w-4 h-4" />
                      <span className="text-sm font-medium">{step.label}</span>
                    </div>
                    {index < 2 && <div className="w-8 h-px bg-theme-divider mx-2"></div>}
                  </div>
                )
              })}
            </div>
            ...
            >
              <div className="flex-1 overflow-y-auto p-6" style={themeBackgroundStyle}>
                <div className="max-w-2xl mx-auto pb-20">
                  <div className="text-center mb-8">
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">页面设置</h2>
                    <p className="text-gray-600">设置页面基本信息和 SEO 选项</p>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-tech-accent focus:border-transparent"
                          placeholder="输入页面标题"
                        />
                      </div>

                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">页面别名 *</label>
                        <input
                          type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">页面摘要</label>
                      <textarea
                        value={pageSettings.excerpt}
                        onChange={(e) => setPageSettings((prev) => ({ ...prev, excerpt: e.target.value }))}
                        rows={3}
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-tech-accent focus:border-transparent resize-none"
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center">
                        ...
                        />
                        <label className="ml-2 text-sm text-gray-700">立即发布页面</label>
                      </div>
                    </div>
