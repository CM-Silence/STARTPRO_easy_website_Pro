...
export default function Layout({
  ...
  return (
    <>
      ...
      <div
        className={`layout-container relative min-h-screen overflow-clip text-theme-text ${!isStarfield ? 'bg-semantic-mutedBg' : ''} ${isThemeDefaultBg ? 'layout-default-bg' : ''} ${className}`}
      >
        ...
        <div className="relative z-10 min-h-screen">
          ...
          <motion.main
            ...
            className="pt-2 main-content content-container max-w-[90%] mx-auto"
