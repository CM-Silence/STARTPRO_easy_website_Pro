import type { ThemeBackgroundChoice, CustomThemePalette } from '@/styles/themes'
// 网站配置类型
...
export interface Settings {
  ...
  transition_main_title?: string
  transition_subtitle?: string
  smooth_scroll?: string
  smooth_scroll_duration?: string
  custom_theme?: CustomThemePalette
}

export type PageTransitionChoice = 'none' | 'fade' | 'slide'
