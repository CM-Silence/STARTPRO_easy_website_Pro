...
export interface NavStyles {
  ...
  /**
   * 渐变文字动画颜色数组（用于 300% background-size 扫描）
   * 例如: ['#primary', '#accent', '#secondary', '#primary']
   */
   ...
   * 下拉项左侧渐变指示条
   */
  accentGradientLeftBar?: string

  /**
   * 语言按钮边框颜色
   */
  langBtnBorderColor?: string

  /**
   * 语言按钮文字颜色
   */
  langBtnTextColor?: string

  /**
   * 语言按钮 hover 渐变填充
   */
  langBtnHoverBg?: string

  /**
   * 语言按钮 hover 文字颜色
   */
  langBtnHoverTextColor?: string
}
